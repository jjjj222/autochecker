...
data_dir="/Users/jjjj222/Documents/Dropbox/2016_fall/NLP/project/autochecker/data/$case_name"
sgml_file="$data_dir/$case_name.sgml"
conll_file="$data_dir/$case_name.conll"
ann_file="$conll_file.ann"
m2_file="$data_dir/$case_name.m2"
